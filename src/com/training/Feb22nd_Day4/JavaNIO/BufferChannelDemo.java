...
public class BufferChannelDemo {
    //Use of Single FileChannel
    // public static FileChannel writeChannel = null;
...
//        ReadableByteChannel channel = in.getChannel(); //Returns a file channel object
    ...
    private static void readFile(Path filePath) throws IOException {
        ...
        //ByteBuffer readBuffer = ByteBufer.allocate(24);
        ...
        try {
            ...
            System.out.println("Reading Text: " + filePath.getFileName()+ " ::"+output);
